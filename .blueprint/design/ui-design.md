...
## Offene Designentscheidungen (für die Abnahme)

| ID | Frage | Optionen |
| --- | --- | --- |
| UD-01 | Seiten-Navigation im Editor | A Seitenleiste (empfohlen) / B Seiten-Tabs oben |
| UD-02 | Änderungswünsche je Screen S-01…S-08 | freie Rückmeldung |
